...
* Неустойчив к повторяющимся элементам.
###### Сложность:
O(n*log(n)) в среднем и худшем случаях.
...
* Гарантированно работает за O(n log n), что является оптимальной сложностью для алгоритмов сравнения.
...
* Не является ин-плейс сортировкой.
###### Сложность:
O(n log n)